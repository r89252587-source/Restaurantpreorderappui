...
import { ArrowLeft, Trash2, Info, CalendarClock, ShoppingBag, UtensilsCrossed } from "lucide-react";
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg">
        <div className="max-w-md mx-auto px-6 py-6">
          ...
          <button
            ...
            className="w-full bg-[#FF0031] text-white rounded-xl py-4 font-medium hover:bg-[#E5002C] transition-colors shadow-lg"
          >
            {selectedOrderType === "pre-booking" && "Confirm Pre-Order"}
            {selectedOrderType === "takeaway" && "Confirm Takeaway"}
            {selectedOrderType === "dine-in" && "Confirm Dine-In"}
          </button>
        </div>
      </div>
    </div>
